...
/* Cette fonction Collapse affiche un panneau avec un titre et un contenu. Le contenu est masqué 
   par défaut et s’ affiche ou se masque au clic sur le chevron haut ou bas. On utilise "useState" pour stocker 
   si le contenu est visible ou non. Au clic sur le chevron, la fonction showContent est appelée pour changer 
   la valeur de l'état isContentVisible. */
